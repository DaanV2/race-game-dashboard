...
func (data *ParticipantData) GetDriverId() uint8 { return data.DriverId }

// SetDriverId stores [ParticipantData.DriverId]
func (data *ParticipantData) SetDriverId(v uint8) { data.DriverId = v }
...
func (data *ParticipantData) GetTeamId() uint8 { return data.TeamId }

// SetTeamId stores [ParticipantData.TeamId]
func (data *ParticipantData) SetTeamId(v uint8) { data.TeamId = v }

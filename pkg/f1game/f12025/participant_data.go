...
// GetName returns the Name of *ParticipantData
func (data *ParticipantData) GetName() [32]byte { return data.Name }

// SetName stores the Name of *ParticipantData
func (data *ParticipantData) SetName(v [32]byte) { data.Name = v }

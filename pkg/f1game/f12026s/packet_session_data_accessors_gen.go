...
// GetActiveAeroZonesFull returns the ActiveAeroZonesFull element of [PacketSessionData] at index
func (data *PacketSessionData) GetActiveAeroZonesFull(index int) ActiveAeroZone {
	return data.ActiveAeroZonesFull[index]
}

// SetActiveAeroZonesFull stores the ActiveAeroZonesFull element of [PacketSessionData] at index
...
// GetActiveAeroZonesPartial returns the ActiveAeroZonesPartial element of [PacketSessionData] at index
func (data *PacketSessionData) GetActiveAeroZonesPartial(index int) ActiveAeroZone {
	return data.ActiveAeroZonesPartial[index]
}

// SetActiveAeroZonesPartial stores the ActiveAeroZonesPartial element of [PacketSessionData] at index
...
// GetDrsZones returns the DrsZones element of [PacketSessionData] at index
func (data *PacketSessionData) GetDrsZones(index int) DRSZone { return data.DrsZones[index] }

// SetDrsZones stores the DrsZones element of [PacketSessionData] at index
